...
export default function FormButton({ props }) {
    let { ...other, text, primary } = props;

    let primaryStyling = tw`bg-blue-500 border-none px-6 py-2 rouded`,
    secondaryStyling = tw`border-blue-500 border bg-transparent px-6 py-2 rouded`,
